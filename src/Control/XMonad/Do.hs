...
-- with indexed monad 'XMonad' instances using RebindableSyntax extension.
--
...
--
-- 'fail' is only needed if your indexed monad is also an instance of 'XMonadFail', which is not recommended.
--
